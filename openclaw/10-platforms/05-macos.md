...
* \*\*IP 报告：\*\*SSH 隧道使用 loopback，因此 Gateway 网关将看到节点 IP 为 `127.0.0.1`。如果你想要显示真实的客户端 IP，请使用 **Direct (ws/wss)** 传输（参见 [macOS 远程访问](/10-platforms/mac/remote)）。

有关设置步骤，请参阅 [macOS 远程访问](/10-platforms/mac/remote)。有关协议详情，请参阅 [Gateway 网关协议](/04-gateway/protocol)。

## 相关文档

* [Gateway 网关运维手册](/gateway)
* [Gateway 网关（macOS）](/10-platforms/mac/bundled-gateway)
* [macOS 权限](/10-platforms/mac/permissions)
* [Canvas](/10-platforms/mac/canvas)
