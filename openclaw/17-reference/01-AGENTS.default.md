...
```bash  theme={null}
cp docs/17-reference/templates/AGENTS.md ~/.openclaw/workspace/AGENTS.md
cp docs/17-reference/templates/SOUL.md ~/.openclaw/workspace/SOUL.md
cp docs/17-reference/templates/TOOLS.md ~/.openclaw/workspace/TOOLS.md
```

3. 可选：如果你想要个人助手 Skills 列表，用此文件替换 AGENTS.md：

```bash  theme={null}
cp docs/17-reference/AGENTS.default.md ~/.openclaw/workspace/AGENTS.md
```
