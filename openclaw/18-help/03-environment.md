...
完整详情参见[配置：环境变量替换](/04-gateway/configuration#env-var-substitution-in-config)。

## 相关内容

* [Gateway 网关配置](/04-gateway/configuration)
* [常见问题：环境变量和 .env 加载](/18-help/faq#env-vars-and-env-loading)
* [模型概述](/03-concepts/models)
