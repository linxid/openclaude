...
* [Gateway 网关故障排除](/04-gateway/troubleshooting)
* [Gateway 网关认证](/04-gateway/authentication)

### 控制 UI 在 HTTP 上失败（需要设备身份）

* [Gateway 网关故障排除](/04-gateway/troubleshooting)
* [控制 UI](/14-web/control-ui#insecure-http)
...
* [Gateway 网关故障排除](/04-gateway/troubleshooting)
* [后台进程/服务](/04-gateway/background-process)

### 模型/认证失败（速率限制、账单、“all models failed”）

* [模型](/05-cli/models)
* [OAuth / 认证概念](/03-concepts/oauth)
