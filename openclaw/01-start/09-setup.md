...
* Node `>=22`
* `pnpm`
* Docker（可选；仅用于容器化设置/e2e — 参阅 [Docker](/02-install/docker)）
...
* **旧版 OAuth 导入**：`~/.openclaw/credentials/oauth.json`
  更多详情：[安全](/04-gateway/security#credential-storage-map)。
...
* [Gateway 网关配置](/04-gateway/configuration)（配置模式 + 示例）
* [Discord](/06-channels/discord) 和 [Telegram](/06-channels/telegram)（回复标签 + replyToMode 设置）
* [OpenClaw 助手设置](/01-start/openclaw)
* [macOS 应用](/10-platforms/macos)（Gateway 网关生命周期）
