...
关于模型选择规则，请参阅 [/03-concepts/models](/03-concepts/models)。
...
参见 [/11-providers/qwen](/11-providers/qwen) 了解设置详情和注意事项。
...
参见 [/11-providers/minimax](/11-providers/minimax) 了解设置详情、模型选项和配置片段。
...
当 Ollama 在本地 `http://127.0.0.1:11434/v1` 运行时会自动检测。参见 [/11-providers/ollama](/11-providers/ollama) 了解模型推荐和自定义配置。
...
另请参阅：[/04-gateway/configuration](/04-gateway/configuration) 了解完整配置示例。
