...
多账户支持：使用 `channels.slack.accounts` 配置每个账户的令牌和可选的 `name`。参见 [`gateway/configuration`](/04-gateway/configuration#telegramaccounts--discordaccounts--slackaccounts--signalaccounts--imessageaccounts) 了解共享模式。
...
* `chat:write`（通过 `chat.postMessage` 发送/更新/删除消息）
  [https://docs.slack.dev/17-reference/methods/chat.postMessage](https://docs.slack.dev/17-reference/methods/chat.postMessage)
* `im:write`（通过 `conversations.open` 打开私信用于用户私信）
  [https://docs.slack.dev/17-reference/methods/conversations.open](https://docs.slack.dev/17-reference/methods/conversations.open)
* `channels:history`、`groups:history`、`im:history`、`mpim:history`
  [https://docs.slack.dev/17-reference/methods/conversations.history](https://docs.slack.dev/17-reference/methods/conversations.history)
* `channels:read`、`groups:read`、`im:read`、`mpim:read`
  [https://docs.slack.dev/17-reference/methods/conversations.info](https://docs.slack.dev/17-reference/methods/conversations.info)
* `users:read`（用户查询）
  [https://docs.slack.dev/17-reference/methods/users.info](https://docs.slack.dev/17-reference/methods/users.info)
* `reactions:read`、`reactions:write`（`reactions.get` / `reactions.add`）
  [https://docs.slack.dev/17-reference/methods/reactions.get](https://docs.slack.dev/17-reference/methods/reactions.get)
  [https://docs.slack.dev/17-reference/methods/reactions.add](https://docs.slack.dev/17-reference/methods/reactions.add)
* `pins:read`、`pins:write`（`pins.list` / `pins.add` / `pins.remove`）
  [https://docs.slack.dev/17-reference/scopes/pins.read](https://docs.slack.dev/17-reference/scopes/pins.read)
  [https://docs.slack.dev/17-reference/scopes/pins.write](https://docs.slack.dev/17-reference/scopes/pins.write)
* `emoji:read`（`emoji.list`）
  [https://docs.slack.dev/17-reference/scopes/emoji.read](https://docs.slack.dev/17-reference/scopes/emoji.read)
...
* `chat:write.public`（仅当我们想发布到机器人未加入的频道时）
  [https://docs.slack.dev/17-reference/scopes/chat.write.public](https://docs.slack.dev/17-reference/scopes/chat.write.public)
...
* 完整命令列表 + 配置：[斜杠命令](/07-tools/slash-commands)
...
* 对于 Slack 工具，表情回应移除语义见 [/07-tools/reactions](/07-tools/reactions)。
