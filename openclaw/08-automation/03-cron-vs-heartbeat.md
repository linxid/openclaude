...
完整配置请参阅[心跳](/04-gateway/heartbeat)。
...
完整 CLI 参考请参阅[定时任务](/08-automation/cron-jobs)。
...
完整用法和示例请参阅 [Lobster](/07-tools/lobster)。
...
* [心跳](/04-gateway/heartbeat) - 完整的心跳配置
* [定时任务](/08-automation/cron-jobs) - 完整的定时任务 CLI 和 API 参考
* [系统](/05-cli/system) - 系统事件 + 心跳控制
