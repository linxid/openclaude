...
* **混合方案：** 将 Gateway 网关保持在廉价 VPS 上，当你需要浏览器/UI 自动化时，将你的 Mac 作为**节点**连接。参见[节点](/nodes)和 [Gateway 网关远程](/04-gateway/remote)。
...
完整设置详情：[BlueBubbles 渠道](/06-channels/bluebubbles)
...
* [VPS 托管](/vps)
* [节点](/nodes)
* [Gateway 网关远程](/04-gateway/remote)
* [BlueBubbles 渠道](/06-channels/bluebubbles)
* [Lume 快速入门](https://cua.ai/docs/lume/guide/getting-started/quickstart)
* [Lume CLI 参考](https://cua.ai/docs/lume/17-reference/cli-reference)
* [无人值守 VM 设置](https://cua.ai/docs/lume/guide/fundamentals/unattended-setup)（高级）
* [Docker 沙箱隔离](/02-install/docker)（替代隔离方案）
